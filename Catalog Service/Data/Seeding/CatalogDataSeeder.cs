    ...
    public static async Task SeedAsync(IServiceProvider serviceProvider)
    {
        ...
        for (int i = 0; i < maxRetries; i++)
        {
            ...
            catch (Exception ex)
            {
                if (i == maxRetries - 1)
                {
                    Console.WriteLine($"[CatalogDataSeeder] Failed database migration: {ex.Message}");
                    logger.LogError(ex, "Failed to migrate CatalogServiceDb database after {MaxRetries} attempts.", maxRetries);
                    throw;
                }
                Console.WriteLine($"[CatalogDataSeeder] Migration failed: {ex.Message}. Retrying in 3 seconds...");
        ...
        try
        {
            ...
            {
                new Category { Id = 1001, Name = "Fresh Bouquets", ImageUrl = "https://images.unsplash.com/photo-1561181286-d3fee7d55364", DisplayOrder = 1, CreatedAt = now },
                new Category { Id = 1002, Name = "Luxury Flower Arrangements", ImageUrl = "https://images.unsplash.com/photo-1526047932273-341f2a7631f9", DisplayOrder = 2, CreatedAt = now },
                new Category { Id = 1003, Name = "Indoor & House Plants", ImageUrl = "https://images.unsplash.com/photo-1485955900006-10f4d324d411", DisplayOrder = 3, CreatedAt = now },
                new Category { Id = 1004, Name = "Velvet & Premium Roses", ImageUrl = "https://images.unsplash.com/photo-1518709268805-4e9042af9f23", DisplayOrder = 4, CreatedAt = now },
                new Category { Id = 1005, Name = "Orchids & Exotic Blooms", ImageUrl = "https://images.unsplash.com/photo-1525310072745-f49212b5ac6d", DisplayOrder = 5, CreatedAt = now },
                new Category { Id = 1006, Name = "Dried & Preserved Florals", ImageUrl = "https://images.unsplash.com/photo-1508610048659-a06b669e3321", DisplayOrder = 6, CreatedAt = now },
                new Category { Id = 1007, Name = "Flower Baskets & Gift Boxes", ImageUrl = "https://images.unsplash.com/photo-1582794543139-8ac9cb0f7b11", DisplayOrder = 7, CreatedAt = now },
                new Category { Id = 1008, Name = "Floral Accessories & Vases", ImageUrl = "https://images.unsplash.com/photo-1612196808214-b7e239e5f6b7", DisplayOrder = 8, CreatedAt = now },
                new Category { Id = 1009, Name = "Bridal & Wedding Collection", ImageUrl = "https://images.unsplash.com/photo-1519741497674-611481863552", DisplayOrder = 9, CreatedAt = now },
                new Category { Id = 1010, Name = "Single Stems & Bunches", ImageUrl = "https://images.unsplash.com/photo-1533616688419-b7a585564566", DisplayOrder = 10, CreatedAt = now },
                new Category { Id = 1011, Name = "Bonsai & Zen Garden", ImageUrl = "https://images.unsplash.com/photo-1512428813834-c702c7702b78", DisplayOrder = 11, CreatedAt = now },
                new Category { Id = 1012, Name = "Chocolates, Cakes & Add-ons", ImageUrl = "https://images.unsplash.com/photo-1549465220-1a8b9238cd48", DisplayOrder = 12, CreatedAt = now }
            };

            var existingCategoryIds = await context.Categories.IgnoreQueryFilters().Select(c => c.Id).ToListAsync();
            var existingCategoryNames = await context.Categories.IgnoreQueryFilters().Select(c => c.Name).ToListAsync();

            var newCategories = categoriesToSeed
                .Where(c => !existingCategoryIds.Contains(c.Id) && !existingCategoryNames.Contains(c.Name))
                .ToList();
            ...
            if (newCategories.Any())
            {
                ...
                Console.WriteLine($"[CatalogDataSeeder] Seeded {newCategories.Count} new categories.");
            }
            else
            {
                Console.WriteLine("[CatalogDataSeeder] Categories already seeded.");
            }

            // ─── 3. Seed Occasions (16 Occasions) ────────────────────────────────────
            var occasionsToSeed = new List<Occasion>
            {
                new Occasion { Id = 2001, Name = "Birthday", ImageUrl = "https://images.unsplash.com/photo-1513151233558-d860c5398176", CreatedAt = now },
                new Occasion { Id = 2002, Name = "Anniversary & Romance", ImageUrl = "https://images.unsplash.com/photo-1518709268805-4e9042af9f23", CreatedAt = now },
                new Occasion { Id = 2003, Name = "Wedding & Celebration", ImageUrl = "https://images.unsplash.com/photo-1519741497674-611481863552", CreatedAt = now },
                new Occasion { Id = 2004, Name = "Graduation", ImageUrl = "https://images.unsplash.com/photo-1523050854058-8df90110c9f1", CreatedAt = now },
                new Occasion { Id = 2005, Name = "Mother's Day", ImageUrl = "https://images.unsplash.com/photo-1526047932273-341f2a7631f9", CreatedAt = now },
                new Occasion { Id = 2006, Name = "Valentine's Day", ImageUrl = "https://images.unsplash.com/photo-1518199266791-5375a83190b7", CreatedAt = now },
                new Occasion { Id = 2007, Name = "Get Well Soon", ImageUrl = "https://images.unsplash.com/photo-1561181286-d3fee7d55364", CreatedAt = now },
                new Occasion { Id = 2008, Name = "Sympathy & Condolence", ImageUrl = "https://images.unsplash.com/photo-1490750967868-88aa4486c946", CreatedAt = now },
                new Occasion { Id = 2009, Name = "Congratulations", ImageUrl = "https://images.unsplash.com/photo-1530103862676-de8c9debad1d", CreatedAt = now },
                new Occasion { Id = 2010, Name = "Thank You", ImageUrl = "https://images.unsplash.com/photo-1469259943454-aa100abb556a", CreatedAt = now },
                new Occasion { Id = 2011, Name = "New Born & Baby Shower", ImageUrl = "https://images.unsplash.com/photo-1519689680058-324335c77eba", CreatedAt = now },
                new Occasion { Id = 2012, Name = "Housewarming", ImageUrl = "https://images.unsplash.com/photo-1513694203232-719a280e022f", CreatedAt = now },
                new Occasion { Id = 2013, Name = "Corporate & Office Events", ImageUrl = "https://images.unsplash.com/photo-1497366216548-37526070297c", CreatedAt = now },
                new Occasion { Id = 2014, Name = "I'm Sorry & Apology", ImageUrl = "https://images.unsplash.com/photo-1508610048659-a06b669e3321", CreatedAt = now },
                new Occasion { Id = 2015, Name = "Eid & Ramadan Mubarak", ImageUrl = "https://images.unsplash.com/photo-1564507592333-c60657eea523", CreatedAt = now },
                new Occasion { Id = 2016, Name = "Festive Holidays & New Year", ImageUrl = "https://images.unsplash.com/photo-1512389142860-9c449e58a543", CreatedAt = now }
            };

            var existingOccasionIds = await context.Occasions.IgnoreQueryFilters().Select(o => o.Id).ToListAsync();
            var existingOccasionNames = await context.Occasions.IgnoreQueryFilters().Select(o => o.Name).ToListAsync();

            var newOccasions = occasionsToSeed
                .Where(o => !existingOccasionIds.Contains(o.Id) && !existingOccasionNames.Contains(o.Name))
                .ToList();
            ...
            if (newOccasions.Any())
            {
                ...
                await context.SaveChangesAsync();
                Console.WriteLine($"[CatalogDataSeeder] Seeded {newOccasions.Count} new occasions.");
            }
            else
            {
                Console.WriteLine("[CatalogDataSeeder] Occasions already seeded.");
            }
            ...
            var productsToSeed = new List<Product>
            {
                ...
                new Product { Id = 3001, Name = "Royal Red Rose Bouquet", Price = 49.99m, DiscountPercentage = 10.00m, DiscountStartAt = now.AddDays(-5), DiscountEndAt = now.AddDays(30), ProductStatus = ProductStatus.Available, Quantity = 50, Description = "A timeless bouquet of 12 long-stemmed premium red roses wrapped in eco-friendly kraft paper.", IsArchived = false, CategoryId = 1001, CreatedAt = now },
                new Product { Id = 3002, Name = "Pastel Dawn Mixed Bouquet", Price = 39.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 35, Description = "Delicate mix of pink carnations, white lilies, and pastel lisianthus paired with fresh eucalyptus.", IsArchived = false, CategoryId = 1001, CreatedAt = now },
                new Product { Id = 3003, Name = "Sunshine Sunflower Delight", Price = 34.99m, DiscountPercentage = 5.00m, DiscountStartAt = now.AddDays(-2), DiscountEndAt = now.AddDays(15), ProductStatus = ProductStatus.Available, Quantity = 25, Description = "Vibrant yellow sunflowers surrounded by solidago and fresh greenery to brighten up any day.", IsArchived = false, CategoryId = 1001, CreatedAt = now },
                new Product { Id = 3025, Name = "Wild Meadow Field Bouquet", Price = 44.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 28, Description = "Lush wildflower-style bouquet featuring blue delphinium, chamomile daisies, and fragrant lavender.", IsArchived = false, CategoryId = 1001, CreatedAt = now },
                new Product { Id = 3026, Name = "Parisian Pink Tulip Symphony", Price = 52.99m, DiscountPercentage = 15.00m, DiscountStartAt = now.AddDays(-3), DiscountEndAt = now.AddDays(20), ProductStatus = ProductStatus.Available, Quantity = 30, Description = "Fresh French pink tulips arranged elegantly with baby eucalyptus in a stylish matte wrap.", IsArchived = false, CategoryId = 1001, CreatedAt = now },
                new Product { Id = 3027, Name = "Lavender Breeze Hand-Tied Bouquet", Price = 37.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 40, Description = "Aromatic purple sea lavender, statice, and white spray roses tied with silk lavender ribbon.", IsArchived = false, CategoryId = 1001, CreatedAt = now },

                // Category 1002: Luxury Flower Arrangements
                new Product { Id = 3004, Name = "Grand Imperial Lily & Rose Box", Price = 89.99m, DiscountPercentage = 15.00m, DiscountStartAt = now.AddDays(-10), DiscountEndAt = now.AddDays(20), ProductStatus = ProductStatus.Available, Quantity = 15, Description = "Opulent arrangement of Casablanca lilies, garden roses, and hydrangeas presented in a signature hatbox.", IsArchived = false, CategoryId = 1002, CreatedAt = now },
                new Product { Id = 3005, Name = "Crystal Glass Peony Symphony", Price = 119.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 10, Description = "Exquisite lush peonies arranged in a hand-cut crystal cylinder vase. Pure elegance for special celebrations.", IsArchived = false, CategoryId = 1002, CreatedAt = now },
                new Product { Id = 3006, Name = "Golden Bloom Deluxe Stand", Price = 149.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 5, Description = "Stunning floor floral stand featuring white orchids, gold-painted foliage, and cascading ivy.", IsArchived = false, CategoryId = 1002, CreatedAt = now },
                new Product { Id = 3028, Name = "Midnight Blue & Gold Velvet Hatbox", Price = 139.99m, DiscountPercentage = 10.00m, DiscountStartAt = now.AddDays(-1), DiscountEndAt = now.AddDays(25), ProductStatus = ProductStatus.Available, Quantity = 8, Description = "Deep sapphire blue dyed roses with gold-dusted ruscus in an embossed navy velvet round box.", IsArchived = false, CategoryId = 1002, CreatedAt = now },
                new Product { Id = 3029, Name = "Cascading White Hydrangea Grandeur", Price = 109.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 12, Description = "Massive heads of cloud-like white hydrangeas with white ranunculus and cascading amaranthus.", IsArchived = false, CategoryId = 1002, CreatedAt = now },
                new Product { Id = 3030, Name = "Opulent Imperial Floral Pedestal", Price = 179.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 4, Description = "Spectacular grand centerpiece with king proteas, cymbidium orchids, and premium garden roses.", IsArchived = false, CategoryId = 1002, CreatedAt = now },

                // Category 1003: Indoor & House Plants
                new Product { Id = 3007, Name = "Monstera Deliciosa Plant", Price = 29.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 40, Description = "Popular Swiss Cheese plant in a white matte ceramic planter. Easy to care for and air-purifying.", IsArchived = false, CategoryId = 1003, CreatedAt = now },
                new Product { Id = 3008, Name = "Peace Lily in Ceramic Pot", Price = 24.99m, DiscountPercentage = 8.00m, DiscountStartAt = now.AddDays(-1), DiscountEndAt = now.AddDays(14), ProductStatus = ProductStatus.Available, Quantity = 30, Description = "Elegant Peace Lily with glossy dark green leaves and graceful white blooms. Great indoor air purifier.", IsArchived = false, CategoryId = 1003, CreatedAt = now },
                new Product { Id = 3009, Name = "Fiddle Leaf Fig Tree", Price = 64.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 12, Description = "Dramatic indoor tree with large violin-shaped leaves. Statement piece for modern living rooms.", IsArchived = false, CategoryId = 1003, CreatedAt = now },
                new Product { Id = 3031, Name = "Golden Pothos Hanging Vine", Price = 19.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 45, Description = "Fast-growing trailing vine with heart-shaped variegated leaves in a bohemian macrame hanging planter.", IsArchived = false, CategoryId = 1003, CreatedAt = now },
                new Product { Id = 3032, Name = "Sansevieria Snake Plant Zeylanica", Price = 27.99m, DiscountPercentage = 5.00m, DiscountStartAt = now.AddDays(-4), DiscountEndAt = now.AddDays(20), ProductStatus = ProductStatus.Available, Quantity = 35, Description = "Ultra low-maintenance architectural plant known for superior oxygen release during nighttime.", IsArchived = false, CategoryId = 1003, CreatedAt = now },
                ...
                new Product { Id = 3010, Name = "Forever Crimson Eternity Roses", Price = 79.99m, DiscountPercentage = 20.00m, DiscountStartAt = now.AddDays(-7), DiscountEndAt = now.AddDays(14), ProductStatus = ProductStatus.Available, Quantity = 20, Description = "Real roses preserved to last up to a year without water. Arranged in a luxury black velvet box.", IsArchived = false, CategoryId = 1004, CreatedAt = now },
                new Product { Id = 3011, Name = "100 Pure White Stem Roses", Price = 199.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 8, Description = "A breathtaking display of 100 premium Ecuadorian white roses representing pure love and new beginnings.", IsArchived = false, CategoryId = 1004, CreatedAt = now },
                ...
                new Product { Id = 3036, Name = "24K Gold Dipped Long-Stem Rose", Price = 49.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 30, Description = "A genuine freshly picked rose dipped in pure 24 karat gold with certificate of authenticity.", IsArchived = false, CategoryId = 1004, CreatedAt = now },

                // Category 1005: Orchids & Exotic Blooms
                new Product { Id = 3013, Name = "Phalaenopsis White Orchid", Price = 44.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 22, Description = "Double-stemmed snow white Moth Orchid planted in a decorative porcelain vessel.", IsArchived = false, CategoryId = 1005, CreatedAt = now },
                new Product { Id = 3014, Name = "Purple Majesty Double Stem Orchid", Price = 54.99m, DiscountPercentage = 10.00m, DiscountStartAt = now.AddDays(-4), DiscountEndAt = now.AddDays(25), ProductStatus = ProductStatus.Available, Quantity = 14, Description = "Vibrant magenta and purple phalaenopsis orchid with cascading blooms.", IsArchived = false, CategoryId = 1005, CreatedAt = now },
                new Product { Id = 3015, Name = "Hawaiian Bird of Paradise Vase", Price = 69.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 12, Description = "Exotic arrangement featuring Strelitzia (Bird of Paradise), red ginger spikes, and monstera leaves.", IsArchived = false, CategoryId = 1005, CreatedAt = now },
                new Product { Id = 3037, Name = "Blue Vanda Orchid Exotic Planter", Price = 79.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 10, Description = "Rare electric blue Vanda orchid displayed in a suspended glass teardrop terrarium.", IsArchived = false, CategoryId = 1005, CreatedAt = now },
                new Product { Id = 3038, Name = "Cymbidium Orchid Cascade Arrangement", Price = 89.99m, DiscountPercentage = 12.00m, DiscountStartAt = now.AddDays(-2), DiscountEndAt = now.AddDays(20), ProductStatus = ProductStatus.Available, Quantity = 9, Description = "Graceful lime green and burgundy Cymbidium orchids styled with bamboo and river pebbles.", IsArchived = false, CategoryId = 1005, CreatedAt = now },
                new Product { Id = 3039, Name = "Tropical Anthurium & Ginger Centerpiece", Price = 58.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 16, Description = "Glossy red anthurium heart flowers paired with pink ginger stems and tropical monstera leaves.", IsArchived = false, CategoryId = 1005, CreatedAt = now },

                // Category 1006: Dried & Preserved Florals
                new Product { Id = 3016, Name = "Rustic Pampas & Dried Eucalyptus", Price = 39.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 30, Description = "Boho-chic arrangement of fluffy natural pampas grass, preserved eucalyptus, and bunny tails.", IsArchived = false, CategoryId = 1006, CreatedAt = now },
                new Product { Id = 3017, Name = "Lavender Dreams Preserved Dome", Price = 49.99m, DiscountPercentage = 15.00m, DiscountStartAt = now.AddDays(-6), DiscountEndAt = now.AddDays(20), ProductStatus = ProductStatus.Available, Quantity = 15, Description = "Real French lavender and mini roses encapsulated in a fairy-lit glass cloche dome.", IsArchived = false, CategoryId = 1006, CreatedAt = now },
                new Product { Id = 3018, Name = "Autumn Harvest Dried Wreath", Price = 55.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 10, Description = "Handcrafted door wreath made of dried wheat stalks, orange slices, pinecones, and cinnamon sticks.", IsArchived = false, CategoryId = 1006, CreatedAt = now },
                new Product { Id = 3040, Name = "Cotton Cloud & Dried Ruscus Cloche", Price = 42.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 20, Description = "Natural raw cotton bolls, bleached ruscus, and star flowers in a wooden base glass display.", IsArchived = false, CategoryId = 1006, CreatedAt = now },
                ...
                new Product { Id = 3042, Name = "Preserved Sakura Cherry Blossom Branch", Price = 65.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 14, Description = "Delicate pink preserved cherry blossoms on natural Japanese hardwood branches.", IsArchived = false, CategoryId = 1006, CreatedAt = now },

                // Category 1007: Flower Baskets & Gift Boxes
                new Product { Id = 3019, Name = "Country Garden Wicker Basket", Price = 54.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 20, Description = "Charming woven rattan basket filled with fresh daisies, spray roses, and baby's breath.", IsArchived = false, CategoryId = 1007, CreatedAt = now },
                new Product { Id = 3020, Name = "Sweet Surprise Flowers & Chocolates Box", Price = 74.99m, DiscountPercentage = 10.00m, DiscountStartAt = now.AddDays(-2), DiscountEndAt = now.AddDays(15), ProductStatus = ProductStatus.Available, Quantity = 16, Description = "Dual-compartment gift box with red roses on top and artisanal pralines tucked beneath.", IsArchived = false, CategoryId = 1007, CreatedAt = now },
                new Product { Id = 3021, Name = "Celebration Champagne & Blossom Hamper", Price = 129.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 7, Description = "Premium gift basket featuring sparkling gourmet cider, French macarons, and pastel blooms.", IsArchived = false, CategoryId = 1007, CreatedAt = now },
                new Product { Id = 3043, Name = "Spa & Lavender Self-Care Gift Basket", Price = 89.99m, DiscountPercentage = 15.00m, DiscountStartAt = now.AddDays(-4), DiscountEndAt = now.AddDays(25), ProductStatus = ProductStatus.Available, Quantity = 15, Description = "Organic lavender essential oils, bath salts, scented soy candle, and fresh mini purple orchids.", IsArchived = false, CategoryId = 1007, CreatedAt = now },
                new Product { Id = 3044, Name = "Luxury Gourmet Fruit & Flower Crate", Price = 95.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 12, Description = "Handcrafted wooden crate loaded with seasonal exotic fruits, grapes, and cheerful yellow blossoms.", IsArchived = false, CategoryId = 1007, CreatedAt = now },
                new Product { Id = 3045, Name = "Artisanal Coffee & Rose Bloom Set", Price = 68.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 18, Description = "Single-origin specialty roasted coffee beans, double-wall ceramic mug, and a mini rose bouquet.", IsArchived = false, CategoryId = 1007, CreatedAt = now },

                // Category 1008: Floral Accessories & Vases
                new Product { Id = 3022, Name = "Handcrafted Artisanal Ceramic Vase", Price = 19.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 50, Description = "Minimalist textured stoneware vase designed to showcase single stems or compact bouquets.", IsArchived = false, CategoryId = 1008, CreatedAt = now },
                new Product { Id = 3023, Name = "Crystal Diamond Cut Flower Vase", Price = 29.99m, DiscountPercentage = 5.00m, DiscountStartAt = now.AddDays(-1), DiscountEndAt = now.AddDays(30), ProductStatus = ProductStatus.Available, Quantity = 40, Description = "Heavy glass vase with light-reflecting diamond facets. Fits medium to large rose bouquets.", IsArchived = false, CategoryId = 1008, CreatedAt = now },
                new Product { Id = 3024, Name = "Plant Care & Nutrient Booster Pack", Price = 12.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 100, Description = "Organic flower food sachets and leaf shine spray for extending cut flower life.", IsArchived = false, CategoryId = 1008, CreatedAt = now },
                new Product { Id = 3046, Name = "Matte Black Nordic Ribbed Vase", Price = 22.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 35, Description = "Scandinavian-style fluted ceramic vase in modern matte anthracite finish.", IsArchived = false, CategoryId = 1008, CreatedAt = now },
                ...
                new Product { Id = 3048, Name = "Professional Florist Shears & Mister Kit", Price = 18.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 60, Description = "High-carbon Japanese steel pruning shears with matching brass water misting bottle.", IsArchived = false, CategoryId = 1008, CreatedAt = now },

                // Category 1009: Bridal & Wedding Collection
                new Product { Id = 3049, Name = "Graceful Cascading Bridal Bouquet", Price = 119.99m, DiscountPercentage = 10.00m, DiscountStartAt = now.AddDays(-5), DiscountEndAt = now.AddDays(30), ProductStatus = ProductStatus.Available, Quantity = 10, Description = "Breathtaking waterfall bouquet of David Austin garden roses, calla lilies, and silver dollar eucalyptus.", IsArchived = false, CategoryId = 1009, CreatedAt = now },
                new Product { Id = 3050, Name = "Groom & Groomsmen Boutonniere Set (4 pcs)", Price = 34.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 25, Description = "Matching white miniature rose boutonnieres with olive leaves and magnetic lapel fasteners.", IsArchived = false, CategoryId = 1009, CreatedAt = now },
                new Product { Id = 3051, Name = "Pure White Wedding Floral Garland (2m)", Price = 179.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 6, Description = "2-meter lush runner crafted with hydrangeas, white spray roses, and Italian ruscus for arches & tables.", IsArchived = false, CategoryId = 1009, CreatedAt = now },
                new Product { Id = 3052, Name = "Blush Peony Bridesmaid Posy", Price = 59.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 15, Description = "Delicate round handheld bouquet of blush Sarah Bernhardt peonies and dusty miller greens.", IsArchived = false, CategoryId = 1009, CreatedAt = now },

                // Category 1010: Single Stems & Bunches
                new Product { Id = 3053, Name = "Fresh Red Explorer Rose Stem", Price = 4.50m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 200, Description = "Single premium long-stem Ecuadorian Explorer red rose with large bloom head.", IsArchived = false, CategoryId = 1010, CreatedAt = now },
                new Product { Id = 3054, Name = "Stem of Pink Stargazer Oriental Lily", Price = 5.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 120, Description = "Fragrant multi-bloom pink oriental lily stem with deep crimson speckles.", IsArchived = false, CategoryId = 1010, CreatedAt = now },
                new Product { Id = 3055, Name = "Single Stem Premium Blue Hydrangea", Price = 7.50m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 80, Description = "Jumbo Dutch blue hydrangea stem with vibrant sky blue florets.", IsArchived = false, CategoryId = 1010, CreatedAt = now },

                // Category 1011: Bonsai & Zen Garden
                new Product { Id = 3056, Name = "Japanese Juniper Bonsai in Glazed Pot", Price = 59.99m, DiscountPercentage = 10.00m, DiscountStartAt = now.AddDays(-2), DiscountEndAt = now.AddDays(20), ProductStatus = ProductStatus.Available, Quantity = 14, Description = "A 5-year-old meticulously pruned Juniper Procumbens in a traditional blue ceramic bonsai tray.", IsArchived = false, CategoryId = 1011, CreatedAt = now },
                new Product { Id = 3057, Name = "Ficus Ginseng Microcarpa Bonsai", Price = 45.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 18, Description = "Distinctive exposed root indoor bonsai tree symbolizing longevity, vitality, and peace.", IsArchived = false, CategoryId = 1011, CreatedAt = now },
                new Product { Id = 3058, Name = "Deluxe Desktop Zen Rock & Sand Garden", Price = 34.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 25, Description = "Meditative zen garden with fine quartz sand, bamboo rake, river stones, and mini air plant.", IsArchived = false, CategoryId = 1011, CreatedAt = now },

                // Category 1012: Chocolates, Cakes & Add-ons
                new Product { Id = 3059, Name = "Belgian Artisan Praline Gift Box (16 pcs)", Price = 24.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 50, Description = "Assorted handcrafted dark, milk, and white Belgian chocolates filled with ganache and hazelnut praline.", IsArchived = false, CategoryId = 1012, CreatedAt = now },
                new Product { Id = 3060, Name = "Red Velvet Mini Celebration Bento Cake", Price = 28.99m, DiscountPercentage = 10.00m, DiscountStartAt = now.AddDays(-1), DiscountEndAt = now.AddDays(10), ProductStatus = ProductStatus.Available, Quantity = 20, Description = "Delicious 4-inch red velvet sponge cake layered with Madagascar vanilla cream cheese frosting.", IsArchived = false, CategoryId = 1012, CreatedAt = now },
                ...
                new Product { Id = 3062, Name = "Fluffy White Teddy Bear with Silk Bow (30cm)", Price = 16.99m, DiscountPercentage = null, ProductStatus = ProductStatus.Available, Quantity = 40, Description = "Ultra-soft premium plush teddy bear holding a miniature red plush heart.", IsArchived = false, CategoryId = 1012, CreatedAt = now }
            };

            var existingProductIds = await context.Products.IgnoreQueryFilters().Select(p => p.Id).ToListAsync();
            ...
            if (newProducts.Any())
            {
                ...
                await context.SaveChangesAsync();
                Console.WriteLine($"[CatalogDataSeeder] Seeded {newProducts.Count} new products.");
            }
            else
            {
                Console.WriteLine("[CatalogDataSeeder] Products already seeded.");
            }

            // ─── 5. Seed Product Images (125+ High Quality Floral Images) ────────────
            ...
            var existingImageIds = await context.ProductImages.IgnoreQueryFilters().Select(pi => pi.Id).ToListAsync();
            ...
            if (productImagesToSeed.Any())
            {
                ...
                await context.SaveChangesAsync();
                Console.WriteLine($"[CatalogDataSeeder] Seeded {productImagesToSeed.Count} product images.");
            }
            else
            {
                Console.WriteLine("[CatalogDataSeeder] Product images already seeded.");
            }

            // ─── 6. Seed Product Occasion Mappings (Comprehensive Many-to-Many) ──────
            ...
            if (newPO.Any())
            {
                ...
                await context.SaveChangesAsync();
                Console.WriteLine($"[CatalogDataSeeder] Seeded {newPO.Count} product-occasion links.");
            }
            else
            {
                Console.WriteLine("[CatalogDataSeeder] Product-occasion links already seeded.");
            }
            ...
            var existingSectionIds = await context.Sections.IgnoreQueryFilters().Select(s => s.Id).ToListAsync();
            ...
            if (newSections.Any())
            {
                ...
                await context.SaveChangesAsync();
                Console.WriteLine($"[CatalogDataSeeder] Seeded {newSections.Count} storefront sections.");
            }
            else
            {
                Console.WriteLine("[CatalogDataSeeder] Storefront sections already seeded.");
            }
        ...
        {
            Console.WriteLine($"[CatalogDataSeeder] ERROR during seeding: {ex.Message}\n{ex.StackTrace}");
